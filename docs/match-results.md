...
| GET | `/api/matches/{id}/goals` | 200 | 404 |
...
GET devuelve los goles ordenados por minuto e identificador, con nombres e identificadores del jugador y del equipo. Esta consulta usa Dapper y no rastrea entidades con EF Core.
